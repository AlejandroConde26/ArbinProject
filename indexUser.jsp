...
<body
    ...
    <%
            ...
            int userId = sessionUser.getId_users();
  ...
  <nav class="navbar navbar-expand-lg bg-white">
    <div class="container-fluid">
      <a class="navbar-brand" href="SvCargarHousings">
        ...
        <form action="BuscarHotelSucursal" method="get"style="display: flex;align-items: center; justify-content: center; gap: 10px;" >
            ...
            <!-- Botón de mensajes -->
                    <btn type="button" class="user-profile">
                        <a href="SvListConversations"><i class="fa-solid fa-comment"></i></a>
                    </btn>
...
<footer class="footer bg-black text-light h-100 position-relative overflow-hidden p-5">
  ...
  <div class="modal fade" id="modalConversaciones" tabindex="-1" aria-labelledby="modalConversacionesLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold text-primary" id="modalConversacionesLabel">
                            <i class="fa-solid fa-envelope-open-text me-2"></i> Tus Conversaciones
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>Chat con <%= u.getFull_name()%></span>
                                <a href="SvViewConversation?idReceptor=<%= u.getId_users()%>&tipoVista=user"class="btn btn-outline-primary btn-sm">Ir</a>
                            </li>
                            <% } %>
                        </ul>
                        <% } else { %>
...
<script>
    var modal = new bootstrap.Modal(document.getElementById('modalConversaciones'));
    modal.show();
</script>
<% } %>
  </body>
