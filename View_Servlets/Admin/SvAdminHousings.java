 ...
 * @author Alex
 */
@WebServlet(name = "SvAdminHousings", urlPatterns = {"/SvAdminHousings"})
public class SvAdminHousings extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
                 ...
                 request.getRequestDispatcher("indexAdminHousting.jsp").forward(request, response);
    }
