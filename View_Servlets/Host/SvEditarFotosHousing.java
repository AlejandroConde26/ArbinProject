 ...
 * @author Alex
 */
@WebServlet(name = "SvEditarFotosHousing", urlPatterns = {"/SvEditarFotosHousing"})
public class SvEditarFotosHousing extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try {
            ...
            if (housing != null) {
                ...
                response.sendRedirect("error.jsp"); // o una página de error personalizada
            }
